...
const AuthenticationForm: React.FC<AuthenticationFormProps> = ({ formData, onLogin }) => {
        ...
        <div>
            ...
            <div className="flex mb-6 bg-gray-100 rounded-lg p-1">
                <button
                    ...
                    className={`flex-1 py-2 px-4 rounded-md text-sm font-medium transition-colors ${isLogin ? 'bg-white text-gray-900 shadow-sm' : 'text-gray-500'
                        }`}
                >
