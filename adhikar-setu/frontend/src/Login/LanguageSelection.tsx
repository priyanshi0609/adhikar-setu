...
const LanguageSelection: React.FC<LanguageSelectionProps> = ({
    ...
    const getRoleNote = (): { hi: string; en: string } => {
        const notes: Record<
            string,
            { hi: string; en: string }
        > = {
            ...
            <div className="space-y-4 max-w-md mx-auto">
                {languages.map((language) => (
                    <button
                        ...
                        className={`w-full p-6 border-2 rounded-lg text-center transition-all duration-200 ${selectedLanguage === language.code
                    ...
                    >
                        <div className="flex items-center justify-between">
                            ...
                            <div
                                className={`w-5 h-5 rounded-full border-2 ${selectedLanguage === language.code
