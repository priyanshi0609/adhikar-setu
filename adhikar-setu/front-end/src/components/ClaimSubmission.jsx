...
const ClaimSubmission = ({ user = {}, language = 'en' }) => {
  ...
  useEffect(() => {
    ...
    mapboxgl.accessToken = import.meta.env.VITE_MAPBOX_TOKEN || "pk.eyJ1IjoiYXJzaHRpd2FyaSIsImEiOiJjbTJhODE2dm8wZ2MxMmlxdTJkbnJ1aTZnIn0.m9ky2-2MfcdA37RIVoxC_w";
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              <div className="lg:col-span-2">
                <div className="relative" style={{ height: '500px' }}>
                  <div ref={mapContainerRef} id="map" style={{ height: '100%', width: '100%', borderRadius: '8px' }}></div>
                  <div
                      ...
                      {roundedArea && (
                        <>
                          <p style={{ ...paragraphStyle, marginTop: 8 }}>
                            <strong>{roundedArea.squareMeters}</strong> sq meters
                          </p>
              ...
              <div className="space-y-4">
                ...
                >
                  {language === 'en' ? 'Get Current Map Center' : 'वर्तमान मैप केंद्र प्राप्त करें'}
                </button>
                ...
                <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                  ...
                  <ul className="text-sm text-green-800 space-y-1">
                    <li>• {language === 'en' ? 'Click polygon tool to start drawing' : 'ड्राइंग शुरू करने के लिए पॉलीगॉन टूल पर क्लिक करें'}</li>
                    <li>• {language === 'en' ? 'Click points to create boundary' : 'सीमा बनाने के लिए बिंदुओं पर क्लिक करें'}</li>
                    <li>• {language === 'en' ? 'Double-click to finish polygon' : 'पॉलीगॉन समाप्त करने के लिए डबल-क्लिक करें'}</li>
                    <li>• {language === 'en' ? 'Use trash tool to delete' : 'हटाने के लिए ट्रैश टूल का उपयोग करें'}</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-50 rounded-lg p-6 space-y-4">
              ...
              {roundedArea && (
                <div className="mt-4 p-4 bg-green-50 rounded-lg">
                  <h4 className="font-semibold text-green-900 mb-2">
                    {language === 'en' ? 'Drawn Area Details' : 'खींचे गए क्षेत्र का विवरण'}
                  </h4>
