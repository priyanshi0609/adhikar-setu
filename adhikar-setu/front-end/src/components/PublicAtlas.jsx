              ...
              <table className="w-full table-auto">
                <thead>
                  <tr className="border-b border-gray-200">
                    <th className="text-left py-3 px-4 font-semibold text-gray-900">{language === 'en' ? 'District' : 'जिला'}</th>
                    <th className="text-left py-3 px-4 font-semibold text-gray-900">{language === 'en' ? 'Total Claims' : 'कुल दावे'}</th>
                    <th className="text-left py-3 px-4 font-semibold text-gray-900">{language === 'en' ? 'Rights Granted' : 'अधिकार प्रदान'}</th>
                    <th className="text-left py-3 px-4 font-semibold text-gray-900">{language === 'en' ? 'Area (Ha)' : 'क्षेत्रफल (हे.)'}</th>
                    <th className="text-left py-3 px-4 font-semibold text-gray-900">{language === 'en' ? 'Families' : 'परिवार'}</th>
                    <th className="text-left py-3 px-4 font-semibold text-gray-900">{language === 'en' ? 'Success Rate' : 'सफलता दर'}</th>
                  </tr>
                </thead>
                <tbody>
