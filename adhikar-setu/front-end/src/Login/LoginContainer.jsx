...
const LoginContainer = ({ onLogin }) => {
  ...
  const canProceed = () => {
    switch (currentStep) {
      ...
      case 2: return formData.language !== null;
      case 3: 
        if (['slmc', 'mota', 'ngo', 'researcher'].includes(formData.role)) return true;
  ...
  const isAuthStep = () => {
    return (currentStep === 4) || 
           (currentStep === 3 && ['slmc', 'mota', 'ngo', 'researcher'].includes(formData.role));
  };
